...
class _LoginState extends State<Login> {
            ...
            child: ListView(
              children: <Widget>[
                ...
                TextFormField(
                  validator: (value) {
                    if (value.isEmpty)
                      return "O campo de e-mail não foi preenchido.";
                    else if (!value.contains("@"))
                      return "O e-mail não foi digitado corretamente.";
                    else
                      return null;
                  },
                ...
                TextFormField
                  (
                  validator: (text){
                    if(text.isEmpty) return 'O campo de senha não foi preenchido.';
                    else return null;
                  },
  ...
  void _onFail() {
    _scaffoldKey.currentState.showSnackBar(
        SnackBar(
          content: Text("Falha ao fazer login, verifique email e senha."),
